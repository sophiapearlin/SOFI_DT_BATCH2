...
public class ProductController {
	...
	ModelAndView addProduct(HttpServletRequest request, @RequestParam("file") MultipartFile file,
		...
		if (!file.isEmpty()) {
			try {
				...
				BufferedOutputStream buffStream = new BufferedOutputStream(new FileOutputStream(
						new File("D:/Users/Hp/workspace2/homedecors/src/main/webapp/resources/images/" + fileName)));
		...
		File oldName = new File("D:/Users/Hp/workspace2/homedecors/src/main/webapp/resources/images/" + fileName);
		File newName = new File("D:/Users/Hp/workspace2/homedecors/src/main/webapp/resources/images/" + product.getId()
